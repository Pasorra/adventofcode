...
sorted_items = sorted(sorted_items, key=lambda x: x.dir_size, reverse=True)

space_needed = 30000000 - (70000000 - sorted_items[0].dir_size)
print(space_needed)

for item in sorted_items[::-1]:
    if item.dir_size >= space_needed:
        print(item.dir_size)
        break
